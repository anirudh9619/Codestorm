...
<nav class="w3-sidenav" id="mySidenav">
 ...
 <a href="side_bar.php?filename=side_bar\html_table.txt">How to Create tables?</a>
  <a href="side_bar.php?filename=side_bar\img.txt">How to insert images?</a>
 <a href="side_bar.php?filename=side_bar\html_form.txt">How to design a form?</a>
 <a href="side_bar.php?filename=side_bar\html_frame.txt">How to divide page into frames?</a>
 <a href="side_bar.php?filename=side_bar\html_list.txt">How to create list?</a>
 <a href="side_bar.php?filename=side_bar\html_audio.txt">How to include audio file?</a>
 <a href="side_bar.php?filename=side_bar\html_video.txt">How to include video file?</a>
 <a href="side_bar.php?filename=side_bar\html_class.txt">How to create classes ?</a>
 <a href="side_bar.php?filename=side_bar\css in html.txt">How to add css code?</a>
 <a href="side_bar.php?filename=side_bar\html_js.txt">How to add javascript code?</a>
 <div class="w3-container">
  <h4>CSS</h4>
 </div>
 <a href="side_bar.php?filename=side_bar\css_bckgrnd.txt">How to add background?</a>
 <a href="side_bar.php?filename=side_bar\css_acc.txt">How to add accordian?</a>
 <a href="side_bar.php?filename=side_bar\css_animation.txt">How to animate a button?</a>
 <a href="side_bar.php?filename=side_bar\css_tab_highlight.txt">How to create highlighted tab?</a>
 <a href="side_bar.php?filename=side_bar\css_close_tab.txt">How to add tab that can also be closed?</a>
 <a href="side_bar.php?filename=side_bar\css_menu_icon.txt">How to interactive menu icon?</a>
 <a href="side_bar.php?filename=side_bar\css_nav.txt">How to create a navigation bar?</a>
 <a href="side_bar.php?filename=side_bar\css_pagi.txt">How to insert pagination?</a>
 <a href="side_bar.php?filename=side_bar\css_search.txt">How to create responsive search column?</a>
 <a href="side_bar.php?filename=side_bar\css_toggle_switch.txt">How to create toggle switch?</a>
 <a href="side_bar.php?filename=side_bar\css_login.txt">Complete Login page?</a>
