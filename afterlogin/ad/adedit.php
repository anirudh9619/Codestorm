        ...
        <nav class="navbar navbar-inverse navbar-fixed-top">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbar-collapse-3">
                    ...
                    <li><a class="dropdown-toggle" data-toggle="dropdown">Page1  <span class="caret" ></span></a>
                    <ul class="dropdown-menu">
                        <li><a href="../et/notes.php">page2</a></li>
                        <li><a href="../et/syllabus.php">page3</a></li>
                        <li><a href="../et/paper.php">page4</a></li>
                    </ul>
                </li>
